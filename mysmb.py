...
def _put_trans_data(transCmd, parameters, data=b'', noPad=False):
...
class MYSMB(smb.SMB):
	...
	def do_write_andx_raw_pipe(self, fid, data, mid=None, pid=None, tid=None):
		...
		writeAndX['Data'] = b'\x00' + data  # pad 1 byte
	...
	def create_trans_packet(self, setup, param=b'', data=b'', mid=None, maxSetupCount=None, totalParameterCount=None, totalDataCount=None, maxParameterCount=None, maxDataCount=None, pid=None, tid=None, noPad=False):
	...
	def send_trans_secondary(self, mid, param=b'', paramDisplacement=0, data='', dataDisplacement=0, pid=None, tid=None, noPad=False):
		self.send_raw(self.create_trans_secondary_packet(mid, param, paramDisplacement, data, dataDisplacement, pid, tid, noPad))

	def create_trans2_packet(self, setup, param=b'', data=b'', mid=None, maxSetupCount=None, totalParameterCount=None, totalDataCount=None, maxParameterCount=None, maxDataCount=None, pid=None, tid=None, noPad=False):
		if maxSetupCount is None:
			maxSetupCount = len(setup)
		if totalParameterCount is None:
			totalParameterCount = len(param)
	...
	def send_trans2(self, setup, param=b'', data=b'', mid=None, maxSetupCount=None, totalParameterCount=None, totalDataCount=None, maxParameterCount=None, maxDataCount=None, pid=None, tid=None, noPad=False):
	...
	def create_trans2_secondary_packet(self, mid, param=b'', paramDisplacement=0, data=b'', dataDisplacement=0, pid=None, tid=None, noPad=False):
	...
	def send_trans2_secondary(self, mid, param=b'', paramDisplacement=0, data=b'', dataDisplacement=0, pid=None, tid=None, noPad=False):
		self.send_raw(self.create_trans2_secondary_packet(mid, param, paramDisplacement, data, dataDisplacement, pid, tid, noPad))

	def create_nt_trans_packet(self, function, setup=b'', param='', data=b'', mid=None, maxSetupCount=None, totalParameterCount=None, totalDataCount=None, maxParameterCount=None, maxDataCount=None, pid=None, tid=None, noPad=False):
		if maxSetupCount is None:
			maxSetupCount = len(setup)
		if totalParameterCount is None:
			totalParameterCount = len(param)
	...
	def send_nt_trans(self, function, setup=b'', param=b'', data=b'', mid=None, maxSetupCount=None, totalParameterCount=None, totalDataCount=None, maxParameterCount=None, maxDataCount=None, pid=None, tid=None, noPad=False):
	...
	def send_nt_trans_secondary(self, mid, param=b'', paramDisplacement=0, data=b'', dataDisplacement=0, pid=None, tid=None, noPad=False):
